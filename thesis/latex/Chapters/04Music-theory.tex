\section{Music theory}
  ...
  \subsection{Scales and Keys}
    ...
    To lead us to the dominant functions we have what are called the pre-dominant function. This simply means 'before dominant', and their function is to set up the tension to lead us to the dominant degrees which in turn leads us back to the tonic. 
