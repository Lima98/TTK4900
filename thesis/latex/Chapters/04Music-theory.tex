\section{Music theory}
  ...
  \subsection{Notes}
    The very core of music is sound. Sounds are vibration in air which we interpret as pitches if the oscillation is somewhat stable. In the western system we agree upon the standard of pitches is based around \musPitch{A}{4} which is $440Hz$. The subsript four indicates the fourth octave. All other pitches are tuned in relation to this reference.
