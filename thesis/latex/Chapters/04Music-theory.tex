\section{Music theory}
  ...
  \subsection{Scales and Keys}
    ...
    \begin{example}[H]
      ...
      \end{center}
      \caption{The \musPitch{C}{}-major scale written in the treble clef. \examplelink.}
    ...
    \begin{example}[H]
      ...
      \end{center}
      \caption{The \musPitch{E\fl}{}-major scale written in the treble clef. \examplelink.}
  ...
  \subsection{Intervals}
    ...
    \begin{example}[h]
      ...
      \end{center}
      \caption{All the musical intervals from the unison to the octave including their variants. \examplelink.}\label{fig:all_intervals}
    \end{example}
  ...
  \subsection{Harmony}\label{sec:harmony}
    ...
    \begin{example}[h]
      ...
      \end{center}
      \caption{The four main triads(chords with three notes), major, minor, diminished and augmented. \examplelink.}\label{fig:four_chords}
    \end{example}
  ...
  \subsection{Musical form}
    ...
    \begin{example}[h]
      ...
      \end{center}
      \caption{A classical example of the musical sentence form. These are the opening bars of Beethovens piano sonata in F-minor \cite{SentenceMusic2023}. \examplelink}\label{fig:sentence}
    \end{example}
    ...
    \begin{example}[h]
      ...
      \end{center}
      \caption{A classical example of the musical period form. This is the melody of the British folk song \textit{Greensleves} \cite{PeriodMusic2025}. \examplelink}\label{fig:period}
    \end{example}
