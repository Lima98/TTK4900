...
\section{Implementation}
  ...
  \lstinputlisting[language=Python, firstline=28, lastline=40]{../../code/.old/.old_iter1/generators/generator.py}
...
\section{Results}
  ...
  \begin{example}
    ...
    \end{center}
    \caption{Melody showing how the octave is not restricted and ends up in unplayable range. \examplelink.}\label{fig:iter1_register}
  \end{example}
  ...
  \begin{example}
    ...
    \end{center}
    \caption{Melody showing how we can generate multiple voices with different rhythmic restrictions. \examplelink.}\label{fig:iter1_voices}
  \end{example}
  ...
  \begin{example}
    ...
    \end{center}
    \caption{Example melody of the first iteration melody generator. \examplelink.}\label{fig:iter1_melody}
  \end{example}
