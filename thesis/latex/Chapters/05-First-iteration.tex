...
\section{Goals for next iteration}
  The main goal for the second iteration is to improve the modelling of the musical concepts like motifs, phrases, musical notes and duration as well as the keys and scales. If we have a better and more robust model for these concepts the implementation of the melodic and harmonic rules will be much easier. Additionally it will be easier to maintain as the current iteration is quite hard to read and understand. 
