...
\lstinputlisting[language=Python, firstline=48, lastline=114, basicstyle=\ttfamily\footnotesize, breaklines=true, breakatwhitespace=true, columns=fullflexible]{../../code/melody_engine/structure.py}

This is a more useful view of the third iteration than a very small note object on its own. \texttt{VoiceProfile} gives the generator a way to talk about range and tessitura, \texttt{FormSection} and \texttt{FormPlan} describe larger formal roles such as repetition and cadence, and \texttt{Motif} makes it possible to store and transform a musical cell as an object instead of only reproducing it procedurally. Taken together, these structures show that the third iteration is not just generating more notes, but reasoning about richer musical objects.
...
\lstinputlisting[language=Python, firstline=66, lastline=99, basicstyle=\ttfamily\footnotesize, breaklines=true, breakatwhitespace=true, columns=fullflexible]{../../code/melody_engine/generator.py}
