...
The student shall:
\begin{itemize}
  \item Develop a procedural system for melody generation that can create coherent and self-similar musical ideas
  \item Explore the use of artificial intelligence as a development tool in the process of building this system, evaluating its benefits and limitations.
\end{itemize}
% ////////// PROBLEM SOLUTION
