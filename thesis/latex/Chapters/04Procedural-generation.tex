...
\ac{PCG}, often reffered to as just \ac{PG}, is algorithmic generation of content. This content can take many forms including landscape, levels, textures or even 3D models. This leads to smaller file sizes since the program can generate the content using algorithms rather than having everything pre-made and saved. 
  ...
  \subsection{Wave function collapse}
    ...
    \begin{figure}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{figures/04theory/patterns.png}
      \end{center}
      \caption{Illustration showing how tiles from the input image is being reused in the procedurally generated output \cite{guminWaveFunctionCollapse2016}.}\label{fig:wfc_patterns}
      \end{figure}
  ...
  \textbf{\color{red}WIP section}\\
    ...
    \begin{figure}[h]
      ...
      \end{center}
      \caption{Initial domain and domain after AC-3 propagation.}\label{fig:domain_prop}
    \end{figure}
  ...
  \textbf{\color{red}WIP section}\\
    ...
    \begin{figure}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{figures/04theory/01_bsp_partitions.pdf}
      \end{center}
      \caption{}\label{fig:bsp_partitions}
    \end{figure}
    
    \begin{figure}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{figures/04theory/02_rooms_and_corridors.pdf}
      \end{center}
      \caption{}\label{fig:rooms_and_corridors}
    \end{figure}

    \begin{figure}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{figures/04theory/03_final_bsp_dungeon.pdf}
      \end{center}
      \caption{}\label{fig:final_bsp_dungeoun}
    \end{figure}
