\section{Procedural generation}
  \ac{PG} is algorithmic generation of content. This content can take many forms including landscape, levels, textures or even 3D models. This leads to smaller file sizes since the program can generate the content using algorithms rather than having everything pre-made and saved. 
  ...
  \subsection{Random walks}
    Random walks are often used in generating maps or other spaces. The random walk works by having an entity walk around "drunkenly", in this case meaning randomly. Then the path is traced, either to create a circumference of an area or the traversed spaces become the area itself. Oftentimes the drunk walker has a set amount of time or steps it can walk before it is terminated, then a new walker is placed at a random location, this helps to smooth out the generated area.

    The same technique can be used to create textures as well, in REFERENCE HERE we can see how changing the colours and directional bias we can generate textures that imitate real life. In the tree and sand example the directional bias is vertial for the tree texture and diagonal for the sand texture. For the map texture it is uniform directional bias, but colouring to indicate water, land and mountains. The least traveled to square get more blue, and the more frequent it goes to green and brown/white to indicate mountains.

  \begin{figure}[htp]
    \centering
      \includegraphics[width=0.3\textwidth]{figures/ex_wood.png}
      \includegraphics[width=0.3\textwidth]{figures/ex_sand.png}
      \includegraphics[width=0.3\textwidth]{figures/ex_map.png}
