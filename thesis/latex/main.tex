...
\noindent \textbf{\Large Procedural generation: generating music using a bi-directional two-model system for complex melody generation} \\
\vspace{0.5cm}

\noindent {\large Procedural generation using bi-directional two-model system algorhithm design using an iterative software design method.} \\
...
\vfill
\noindent All examples can be found at my \href{https://folk.ntnu.no/janoivil}{NTNU-webpage} where they can be listened to, numberings are consistent with the thesis for convenience.
% === === === === === === 
