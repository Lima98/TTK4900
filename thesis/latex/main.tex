...
\noindent \textbf{\Large Procedural generation: generating music using a bi-directional two-model system for complex generation} \\
\vspace{0.5cm}
...
\vfill
\noindent All examples can be found at my \href{https://www.janoivil.fol.ntnu.no}{NTNU-webpage} where they can be listened to, numberings are consistent with the thesis for convenience.
