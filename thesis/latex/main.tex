...
\usepackage{pdfpages} %to include generated pdf pages such as the repository readme appendix
...
\makeatletter
\newcommand{\master@linktext}{Listen in the online archive}
\newcommand{\examplelink}[1][\master@linktext]{%
  \begingroup
  \edef\master@rawexample{\theexample}%
  \StrSubstitute{\master@rawexample}{.}{-}[\master@anchorexample]%
  \xdef\master@currentlink{\noexpand\href{https://lima98.github.io/TTK4900/\#example-\master@anchorexample}{#1}}%
  \endgroup
  \master@currentlink
}
\fancypagestyle{readmeappendix}{%
  \fancyhf{}%
  \fancyhead[C]{\footnotesize Included from \texttt{README.md} (page \AM@page/\AM@pagecount)}%
  \fancyfoot[C]{\thepage}%
...
\makeatletter
     ...
     \renewcommand*{\listof}[2]{%
          \@ifundefined{ext@#1}{\float@error{#1}}{%
               \@namedef{l@#1}{\@dottedtocline{1}{1em}{3.2em}}%
               \float@listhead{#2}%
               \begingroup\setlength{\parskip}{\z@}%
                    \@starttoc{\@nameuse{ext@#1}}%
               \endgroup}}
     \newcommand{\masterfrontlist}[2]{%
          \chapter*{#1}%
          \phantomsection
          \addcontentsline{toc}{chapter}{\protect\numberline{}#1}%
          \@starttoc{#2}}
     \newcommand{\masterlistofexamples}{%
          \@namedef{l@example}{\@dottedtocline{1}{1em}{3.2em}}%
          \masterfrontlist{List of Examples}{loe}}
\makeatother
\newfloat{examples}{htbp}{loe}
...
% \begin{titlepage}
%   \hbadness=10000 % to avoide warnings about underfull hbox in the title page.
%   \newgeometry{left=1.6in, right=2in}
%   \vspace*{1.5cm}
%
%   \noindent  \textcolor{gray}{\large Jan-Øivind Lima} \\
%   \vspace{1cm}
%
%   \noindent \textbf{\Large Iterative Development of a Constraint-Based Procedural Music Generator} \\
%   \vspace{0.5cm}
%
%   \noindent {From simple melodic rules to form- and harmonically-aware generation} \\
%
%
%
%   % \vspace{7cm}
...
\hbadness = 10000 % to avoid warnings about underfull hbox in the abstract
...
\masterfrontlist{\contentsname}{toc}

%add to table of contents list of figures and tables, and insert list of figures and tables
\masterfrontlist{\listfigurename}{lof}
% === LIST OF EXAMPLES ===
\masterlistofexamples
\vfill
\noindent All examples can be found at my \href{https://lima98.github.io/TTK4900}{github.io page} where they can be listened to, numberings are consistent with the thesis.
% === === === === === === 
% \listoftables
...
% \input{Chapters/05-1SoftwareDesign}
% \cleardoublepage

\chapter{The First Iteration}
\input{Chapters/05-First-iteration}
\cleardoublepage
\chapter{The Second Iteration}
\input{Chapters/05-Second-iteration}
\cleardoublepage
\chapter{The Third Iteration}
\input{Chapters/05-Third-iteration}
\cleardoublepage
