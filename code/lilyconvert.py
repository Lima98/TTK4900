...
def write_to_file(lilypond_code, filename="code/output/default/output.ly"):
    ...
    Args:
        ...
        filename (): The name of the file where the LilyPond code will be saved. Default is "code/output/default/output.ly". 
    """
...
def generate_files(filename="code/output/default/output.ly", path = "code/output/"):
    ...
    Args:
        filename (): The name of the LilyPond file to be processed, including its path. Default is "code/output/default/output.ly".
        path (): The directory where the generated files (PDF, MIDI, PNG) will be saved. Default is "code/output/". The function uses the subprocess module to run the LilyPond command-line tool, which processes the specified LilyPond file and generates the corresponding output files in the specified directory. The "-o" option specifies the output directory, and the "-dcrop" option tells LilyPond to crop the PDF output to fit the content.
    """
